...
public class AdaptiveTrackSelection extends BaseTrackSelection {
  ...
  public static final float DEFAULT_BANDWIDTH_FRACTION = 1.0f; //0.7f;
  public static final float DEFAULT_BUFFERED_FRACTION_TO_LIVE_EDGE_FOR_QUALITY_INCREASE = 1.0f; //0.75f
